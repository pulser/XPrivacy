...
public class XPrivacy implements IXposedHookLoadPackage, IXposedHookZygoteInit {
	...
	public void initZygote(StartupParam startupParam) throws Throwable {
        ...
        hook(new XSmsManager("sendDataMessage", XRestriction.cMessages, new String[] { "SEND_SMS" }),
                "android.telephony.SmsManager");
        hook(new XSmsManager("sendMultipartTextMessage", XRestriction.cMessages, new String[] { "SEND_SMS" }),
                "android.telephony.SmsManager");
        hook(new XSmsManager("sendTextMessage", XRestriction.cMessages, new String[] { "SEND_SMS" }),
                "android.telephony.SmsManager");
